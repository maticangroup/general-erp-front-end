    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand text-center" href="/">
                <img alt="logo" class="header-brand-img main-logo" src="/assets/images/photos/Matican Logo.png">
                <img alt="logo" class="header-brand-img mobile-logo" src="/assets/images/photos/Matican Logo.png">
            </a>
                ...
                <div class="dropdown">
                    <a class="nav-link pr-0 leading-none d-flex" data-toggle="dropdown" href="#">
                        ...
                        <span class="ml-2 d-none d-lg-block">
                                        <span class="text-dark">Hossein Azimi</span>
                                    </span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                        <a class="dropdown-item" href="#"><i class="dropdown-icon fe fe-user"></i>My
                            Profile</a>
                        <a class="dropdown-item" href="#"><i class="dropdown-icon fe fe-edit"></i>My
                            Schedule</a>
                        <a class="dropdown-item" href="#"><i class="dropdown-icon fe fe-mail"></i> My
                            Inbox</a>
                        <a class="dropdown-item" href="#"><i class="dropdown-icon fe fe-unlock"></i> Look
                            Screen</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#"><i class="dropdown-icon fe fe-power"></i> Log
                            Out</a>
                    </div>
                </div>
        ...
        <div class="d-flex order-lg-2 ml-auto">
            ...
            <div class="dropdown  d-md-flex header-contact">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item text-center " href="#">View
                        all contact list</a>
                </div>
            </div>
