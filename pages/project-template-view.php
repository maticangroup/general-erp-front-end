...
<div class="mb-5">
    <div class="page-header  mb-0">
        <h4 class="page-title">Project Template</h4>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">"Milestone 1" work flow</h3>
            </div>
            <div class="card-body">
                <div class="timeline">
                        ...
                        <div class="timeline__items">
                            <div class="timeline__item">
                                <div class="timeline__content text-left ">
                                    ...
                                    <div class="row">
                                        <div class="col-12"><strong>Title:</strong></div>
                                    ...
                                    <div class="row">
                                        <div class="col-12"><strong>Blocker:</strong></div>
                                        <div class="col-12 text-right">
                                            #5234723
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12"><strong>Plan at:</strong></div>
                                        <div class="col-12 text-right">
                                            10%
                                        </div>
                                    </div>
                            ...
                            <div class="timeline__item">
                                <div class="timeline__content bg-teal text-white text-left ">
                                    <div class="row">
                                        <div class="col-6">
                                            <h3>Call</h3>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col"><strong>Blocker:</strong></div>
                                        <div class="col">
                                            #5234723
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col"><strong>Plan at</strong></div>
                                        <div class="col">
                                            25%
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 text-right">
                                            <a href="#" class="btn btn-secondary btn-block" data-toggle="modal"
                                               data-target="#add-call-modal">Call</a>
                                        </div>
                                        <div class="col-6 text-right">
                                            <a href="#" class="btn btn-secondary btn-block" data-toggle="modal"
                                               data-target="#add-task-modal">Task</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="card ">
            ...
            <div class="card-body">
                <div class="card bg-primary text-white">
                    <div class="card-header">
                        <h4 class="card-title">Milestone 1</h4>
                        <div class="card-options">
                            <a href="#" class="card-options-collapse" data-toggle="card-collapse"><i
                                        class="fe fe-chevron-up text-white"></i></a>
                            <a href="#" class="card-options-remove" data-toggle="card-remove"><i
                                        class="fe fe-trash text-white"></i></a>
                            <a href="#" class=""><i
                                        class="fe fe-edit text-white"></i></a>
                            <a href="#" class=""><i
                                        class="fe fe-eye text-white"></i></a>
                            <a href="#" class="#"><i
                                        class="fe fe-move text-white"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid, eligendi.
                        </p>
                    </div>
                </div>
                <div class="card bg-primary text-white">
                    <div class="card-header">
                        <h4 class="card-title">Milestone 2</h4>
                        <div class="card-options">
                            <a href="#" class="card-options-collapse" data-toggle="card-collapse"><i
                                        class="fe fe-chevron-up text-white"></i></a>
                            <a href="#" class="card-options-remove" data-toggle="card-remove"><i
                ...
                <div class="card bg-primary text-white">
                    <div class="card-header">
                        <h4 class="card-title">Milestone 3</h4>
                        <div class="card-options">
                            <a href="#" class="card-options-collapse" data-toggle="card-collapse"><i
                                        class="fe fe-chevron-up text-white"></i></a>
                            <a href="#" class="card-options-remove" data-toggle="card-remove"><i
                ...
                <div class="card bg-primary text-white">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-right">
                            <a href="#" class="btn btn-success">New Milestone</a>
                        </p>
...
<div class="modal fade" id="add-call-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="example-Modal3-1">Add a template call</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
