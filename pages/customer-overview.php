...
<div class="mb-5">
    <div class="page-header  mb-0">
        <h4 class="page-title">Customer Overview</h4>
        <div class="row">
            <div class="col-12">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="example-Modal3-1">New Customer</h5>
...
<div class="modal fade bd-example-modal-xl" id="transaction-modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="example-Modal3-1">Transaction</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                                ...
                                <table class="table card-table table-vcenter text-nowrap table-bordered">
                                    ...
                                    <tr>
                                        <td rowspan="7" class="text-center">
                                            <div class="font-weight-bold mb-1">Matican Group</div>
                                            <br>
                                            <div class="mb-3">285 - 8000 -11166656 -1 <br>
                                                Bank: Pasargad
                                            </div>
                                        ...
                                        <td rowspan="7" class="text-center">
                                            ...
                                            <img src="../assets/images/photos/Melli-logo-LimooGraphic.png">
                                        </td>
                                        <td class="text-center">15,000,000 Rial</td>
                                    ...
                                    <tr>
                                        <td class="text-center">Internet bank</td>
                                    ...
                                    <tr>
                                        <td rowspan="3" class="text-center">
                                            <div class="font-weight-bold mb-1">Azimi Hossein</div>
                                            <div>Org Code: EM 001233 <br>
                                                Role: Financial Expert
                                            </div>
                                        </td>
                                        <td rowspan="3" class="text-center">
                                            <div>Approved By Financial Unit</div>
                                            <br>
                                        </td>
                                    </tr>
                                    <tr>
...
<!-- Message Modal -->
<div class="modal fade" id="meeting-add-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                            ...
                            <div class="panel panel-primary ">
                                <div class="  border-0">
                                    <div class="tabs-menu ">
                                        ...
                                        <ul class="nav panel-tabs">
                                            <li class="">
                                                <a href="#tab11" class="active font-weight-bold"
                                                   data-toggle="tab">Basic Info</a>
                                            </li>
                                            <li><a href="#tab22" class="font-weight-bold" data-toggle="tab">People</a>
                                            </li>
                                            <li><a href="#tab33" class="font-weight-bold" data-toggle="tab">Timing</a>
                                            </li>
                                            <li><a href="#tab44" class="font-weight-bold" data-toggle="tab">place</a>
                                            </li>
                                            <li><a href="#tab55" class="font-weight-bold" data-toggle="tab">relation</a>
                                            </li>
                                            <li><a href="#tab66" class="font-weight-bold"
                                                        ...
                                                        <div class="row ">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <select class="form-control">
                                                                    ...
                                                                    <option>Portfolio demo</option>
                                                                    <option>Vendor meeting</option>
                                                                    <option>Project Kick off</option>
