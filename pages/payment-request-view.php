...
<div class="mb-5">
    <div class="page-header  mb-0">
        <h4 class="page-title">Payment Request View</h4>
        ...
        <div class="card">
            <div class="card-body">
                <div class="dash-widget text-center">
                    <p>Total Price</p>
                    <h3 class="font-weight-extrabold">24,000,000</h3>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <div class="dash-widget text-center">
                    ...
                    <h3 class="font-weight-extrabold">20,000,000</h3>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <div class="dash-widget text-center">
                    <p class="text-danger">Remaining</p>
                    <h3 class="font-weight-extrabold">4,000,000</h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="edit-modal">Edit Payment Request</h5>
                    ...
                    <div class="card p-3  mb-1 ">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                            class="form-control-label mr-1 font-weight-bold">Total Price:
                                    </label>
                    ...
                    <div class="card p-3  mb-1 ">
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label
                                            class="form-control-label mr-1 font-weight-bold">Inform:
                                    </label>
                                    <input type="text" class="form-control" step="0">
                                </div>
                            </div>
...
<div class="modal fade" id="add-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="add-modal">New Payment Request</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
