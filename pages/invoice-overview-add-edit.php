        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive ">
                    <table id="example-2" class="table table-striped table-bordered nowrap text-center">
                        <thead>
                        <tr>
                            ...
                            <th class="wd-20p border-bottom-0 text-center bg-primary">Date</th>
                            <th class="wd-25p border-bottom-0 text-center bg-primary">Price</th>
                            <th class="wd-10p border-bottom-0 text-center bg-primary">Creator</th>
                            ...
                            <th class="wd-25p border-bottom-0 text-center bg-primary">Payment Request Num</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="example-Modal3-1">New Invoice</h5>
