...
<div class="row">
    <div class="col-xl-4 col-md-12 col-lg-6">
        <div class="mini-stat clearfix bg-primary rounded">
            <span class="mini-stat-icon"><i class="fas fa-poll text-primary"></i></span>
    ...
    <div class="col-xl-2 col-md-12 col-lg-6">
        <div class="mini-stat clearfix bg-primary rounded">
            <span class="mini-stat-icon"><i class="fab fa-hubspot text-primary"></i></span>
            <div class="mini-stat-info text-white">
                <span>100</span>
                For projects
            </div>
    ...
    <div class="col-xl-2 col-md-12 col-lg-6">
        <div class="mini-stat clearfix bg-primary rounded">
            <span class="mini-stat-icon"><i class="fas fa-check text-primary"></i></span>
            <div class="mini-stat-info text-white">
                <span>343</span>
                Checked by TQM
            </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="form-group  clearfix">
                                                        <div class="row ">
                                                            <div class="col-lg-3">
                                                                <label class="control-label form-label font-weight-bold"
                                                                       for="type">Organization Affairs :</label>
                                                            </div>
                                                            <div class="col-lg-9">
                                        ...
                                        <div class="tab-pane" id="tab2">
                                            ...
                                            <span class="avatar avatar-xl brround cover-image m-2"
                                                ...
                                                <span class="avatar-status bg-green"></span>
                                                                            ...
                                                                            <h5 class="mt-3 mb-0"><a
                                                                                        class="hover-primary" href="#">John Taromi</a></h5>
                                                                            <span>Person Position</span>
                                                                            <div>
                                            ...
                                            <span class="avatar avatar-xl brround cover-image m-2"
                                                ...
                                                <span class="avatar-status bg-green"></span>
                                                                            ...
                                                                            <h5 class="mt-3 mb-0"><a
                                                                                        class="hover-primary" href="#">Mehdi Yegane</a></h5>
                                                                            <span>Person Position</span>
                                                                            <div>
