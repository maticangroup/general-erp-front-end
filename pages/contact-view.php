...
<div class="row">
                            ...
                            <ul class="nav panel-tabs">
                                <li><a href="#tab6" class="font-weight-bold active"
                                       data-toggle="tab">Basic
                                        Info</a></li>
                                <li><a href="#tab7" class="font-weight-bold" data-toggle="tab">ORG.
                                        Info</a></li>
                                <li><a href="#tab8" class="font-weight-bold"
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab6">
                                <div class="p-3 text-left">
                                    ...
                                    <div class="media mt-1 pb-2">
                                        ...
                                        <div class="media-body ml-5 mt-1">
                                            <h6 class="mediafont text-dark mb-1">Age</h6><span
                                                    class="d-block">25</span>
                                        </div>
                                    </div>
                                    <div class="media mt-1 pb-2">
                                        <div class="mediaicon">
                                        ...
                                        <div class="media-body ml-5 mt-1">
                                            <h6 class="mediafont text-dark mb-1">Date Of Birth</h6>
                                            <span class="d-block">2/3/73</span>
                                        </div>
                                    </div>
                                    <div class="media mt-1 pb-2">
                                        <div class="mediaicon">
                                        ...
                                        <div class="media-body ml-5 mt-1">
                                            <h6 class="mediafont text-dark mb-1">Phone
                                                Number</h6><span class="d-block">+98 933 566
                                                                    58</span>
                                        </div>
                                    </div>
                                    <div class="media mt-1 pb-2">
                                        ...
                                        <div class="media-body ml-5 mt-1">
                                            <h6 class="mediafont text-dark mb-1">Email
                                                Address</h6><span class="d-block"><a
                                                        href="#">suemartin@gmail.com</a></span>
                                        </div>
                                    </div>
                                    <div class="media mt-1 pb-2">
                                        <div class="mediaicon">
                                        ...
                                        <div class="media-body ml-5 mt-1">
                                            ...
                                            </h6><span class="d-block">Tehran , Enqelab
                                                                    square , street Num.1 </span>
                                        </div>
                                    </div>
                                    <div class="media mt-1 pb-2">
                                        <div class="mediaicon">
                                        ...
                                        <div class="media-body ml-5 mt-1">
                                            <h6 class="mediafont text-dark mb-1">Fax</h6>
                                            <span class="d-block">6655114654</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab7">
                                <div class="media mt-1 pb-2">
                                    ...
                                    <div class="media-body ml-5 mt-1">
                                        <h6 class="mediafont text-dark mb-1">Branch
                                        </h6><span class="d-block">Tehran , Enqelab </span>
                                    </div>
                                </div>
                                <div class="media mt-1 pb-2">
                                    <div class="mediaicon">
                                    ...
                                    <div class="media-body ml-5 mt-1">
                                        <h6 class="mediafont text-dark mb-1">Unit
                                        </h6><span class="d-block">TQM</span>
                                    </div>
                                </div>
                                <div class="media mt-1 pb-2">
                                    <div class="mediaicon">
                                    ...
                                    <div class="media-body ml-5 mt-1">
                                        <h6 class="mediafont text-dark mb-1">Role
                                        </h6><span class="d-block">HR</span>
                                    </div>
                                </div>
                                <div class="media mt-1 pb-2">
                                    <div class="mediaicon">
                                    ...
                                    <div class="media-body ml-5 mt-1">
                                        <h6 class="mediafont text-dark mb-1">Expertise
                                        </h6><span class="d-block">Photographer </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane" id="tab8">
                                <div class="media mt-1 pb-2">
                                    ...
                                    <div class="media-body ml-5 mt-1">
                                        <h6 class="mediafont text-dark mb-1">Salary
                                            Type
                                        </h6><span class="d-block">Per Hour</span>
                                    </div>
                                </div>
                                <div class="media mt-1 pb-2">
                                    <div class="mediaicon">
                                    ...
                                    <div class="media-body ml-5 mt-1">
                                        <h6 class="mediafont text-dark mb-1">Hours
                                            Of Work Per Month
                                        </h6><span class="d-block">227 Hour</span>
                                    </div>
                                </div>
                                <div class="media mt-1 pb-2">
                                    <div class="mediaicon">
                                    ...
                                    <div class="media-body ml-5 mt-1">
                                        <h6 class="mediafont text-dark mb-1">Regular
                                            Rate
                                        </h6><span class="d-block">30,000
                                                                Toman</span>
                                    </div>
                                </div>
                                <div class="media mt-1 pb-2">
                                    ...
                                    <div class="media-body ml-5 mt-1">
                                        <h6 class="mediafont text-dark mb-1">
                                            Overtime Rate
                                        </h6><span class="d-block">22,000
                                                                Toman</span>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="col-8">
        <div id="horizontal-scroll" class="card">
            <div class="card-header">
                <div class="card-title font-weight-bold">Contact Items</div>
            </div>
                        ...
                        <ul>
                            <li>
                                <div id="milestones" class="card">
                                    <div class="card-body text-center">
                                        <img src="../assets/images/svgs/png/044-delivery-15.png"
                            ...
                            <li>
                                <div id="tasks" class="card">
                                    <div class="card-body text-center">
                                        <img src="../assets/images/svgs/png/017-clipboard.png"
                                             alt="img" class="w-8 h-8 mb-4">
                                        <div class="svg-btn">
                                            <a class="btn btn-primary btn-pill"
                                               href="#">Projects</a>
                            ...
                            <li>
                                <div id="invoice" class="card">
                                    <div class="card-body text-center">
                                        <img src="../assets/images/svgs/png/005-bill.png"
                                             alt="img" class="w-8 h-8 mb-4">
                                        <div class="svg-btn">
                                            <a class="btn btn-primary btn-pill"
                                               href="#">Transactions</a>
                            ...
                            <li>
                                <div id="services" class="card">
                                    <div class="card-body text-center">
                                        <img src="../assets/images/svgs/png/071-logistic-13.png"
                                             alt="img"
                                             class="w-8 h-8 mb-4">
                                        <div class="svg-btn">
                                            <a class="btn btn-primary btn-pill" href="#">Deals</a>
                                        </div>
                                        <h3 class="mt-4">10</h3>
                                    </div>
                                </div>
                            ...
                            <li>
                                <div id="vendors" class="card">
                                    <div class="card-body text-center">
                                        <img src="../assets/images/svgs/png/034-delivery-7.png"
                                             alt="img"
                                             class="w-8 h-8 mb-4">
                                        <div class="svg-btn">
                                            <a class="btn btn-primary btn-pill" href="#">Financial
                                                Accounts</a>
                                        </div>
                                        <h3 class="mt-4">12</h3>
                                    </div>
                            ...
                            <div class="panel-body">
                                <div class="card card-collapsed">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table
                                                    class="table card-table table-vcenter table-hover">
                                                <thead>
                                                <tr>
                                                    <th>Num</th>
                                                    <th>Start Date</th>
                ...
                <div class="panel panel-default mt-2">
                    ...
                    <div id="collapseThree3" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="panel-body">
                            <div class="card card-collapsed">
                                <div class="card-header">
                                    <h3 class="card-title">Milestone Detail
                                    </h3>
                                    <div class="card-options">
                                        <a href="#" class="card-options-collapse"
                                           data-toggle="card-collapse"><i
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="edit-modal">Edit Contact</h5>
                ...
                <form autocomplete="off">
                    <div class="card p-3  mb-1 ">
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="first-name"
                                           class="form-control-label mr-1 font-weight-bold">First Name:
                                    </label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="last-name"
                                           class="form-control-label mr-1 font-weight-bold">Last Name:
                                    </label>
                                    <input type="text" class="form-control" id="last-Name" step="0">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="gender"
                                           class="form-control-label mr-1 font-weight-bold">Gender:</label>
                    ...
                    <div class="card p-3  mb-1 ">
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="mobile"
                                           class="form-control-label mr-1 font-weight-bold">Mobile:
                                    </label>
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            <i class="fas fa-mobile-alt"></i>
                                        </div>
                                        <input type="tel" class="form-control" id="mobile" step="0">
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="fax"
                                           class="form-control-label mr-1 font-weight-bold">Fax:
                                    </label>
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            <i class="fas fa-fax"></i>
                                        </div>
                                        <input type="text" class="form-control" id="fax" step="0">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="phone"
                                           class="form-control-label mr-1 font-weight-bold">Phone:
                                    </label>
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            <i class="fas fa-phone"></i>
                                        </div>
                                        <input type="text" class="form-control" id="phone" step="0">
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="email"
                                           class="form-control-label mr-1 font-weight-bold">Email:
                                    </label>
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            <i class="fas fa-at"></i>
                    ...
                    <div class="card p-3  mb-1 ">
                        <div class="form-group ">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <label for="address"
                                           class="form-control-label mr-1 font-weight-bold"></label>
                                    <input type="text" class="form-control mt-2" id="address2"
                                           placeholder="City">
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control mt-2" id="address4"
                                           placeholder="Zip Code">
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control mt-2" id="address3"
                                           placeholder="Street">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card p-3  mb-1 ">
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="role-title"
                                           class="form-control-label mr-1 font-weight-bold">Role
                                        Title:</label>
                                    <select class="form-control" id="role-title">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="unit"
                                           class="form-control-label mr-1 font-weight-bold">Unit:</label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="expertise"
                                           class="form-control-label mr-1 font-weight-bold">Expertise:
                                    </label>
                                    <input type="text" class="form-control" id="expertise" step="0">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card p-3  mb-1 ">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="salary-type"
                                           class="form-control-label mr-1 font-weight-bold">Salary
                                        Type:</label>
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                        ...
                                        <select class="form-control" id="salary-type">
                                            <option>Project Comission</option>
                                            <option>Per Hourly</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="overtime-rate"
                                           class="form-control-label mr-1 font-weight-bold">Overtime
                                        Rate:
                                    </label>
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="regulat-work-time"
                                           class="form-control-label mr-1 font-weight-bold">Regular
                                        Work
                                        Time Per Month:
                                    </label>
                                    <div class="input-group-prepend">
