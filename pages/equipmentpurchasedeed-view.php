...
<div class="mb-5">
    <div class="page-header  mb-0">
        <h4 class="page-title">Purchase Deed View</h4>
    ...
    <div class="col-xl-3 col-lg-12 col-md-12">
        <div class="card ">
            <div class="card-body text-center pt-3 ">
                ...
                <h5 class="mt-3 mb-0"><a class="hover-primary" href="#">Fatemeh Esfandiar</a></h5>
                    ...
                    <div class="col-lg-3 col-md-6 border-right">
                        <div class="card-body text-center">
                            <div class="dash3">
                                ...
                                <h5 class="text-muted">Purchase deed rough value</h5>
                                <h4 class=" text-purple">8.000.000 T</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 border-right">
                        <div class="card-body text-center">
                            <div class="dash3">
                                <div class="icon icon-shape bg-primary rounded-circle text-white mb-3">
                                    <i class="fas fa-comments-dollar text-white"></i>
                                </div>
                                <h5 class="text-muted">Purchase deed instant value</h5>
                                <h4 class=" text-purple">7.560.000 T</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 border-right">
                        <div class="card-body text-center">
                            <div class="dash3">
                                ...
                                <h5 class="text-muted">Total equipment for purchase</h5>
                                <h4 class=" text-purple">5</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 border-right">
                        <div class="card-body text-center">
                            <div class="dash3">
                                ...
                                <h5 class="text-muted">Equipment purchased</h5>
                                <h4 class=" text-purple">3</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive ">
                    <table id="example-5" class="table table-striped table-bordered nowrap">
                        ...
                        <tr>
                            ...
                            <th class="wd-15p border-bottom-0 text-center bg-primary">Equipment name</th>
                            <th class="wd-15p border-bottom-0 text-center bg-primary">Category</th>
                            <th class="wd-10p border-bottom-0 text-center bg-primary">Rough price</th>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="javascriptvoid(0)" data-toggle="modal" data-target="#guarantee-modal" class="btn btn-secondary btn-sm"><i class="fas fa-info-circle"></i> Guarantee info</a>
                            </td>
                        </tr>
                        <tr>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="example-Modal3-1">Edit Purchase Deed</h5>
                                ...
                                <div class="  border-0">
                                    <div class="tabs-menu ">
                                        ...
                                        <ul class="nav panel-tabs">
                                            ...
                                            <li><a href="#tab22" class="font-weight-bold" data-toggle="tab">Purchase Info</a></li>
                                            <li><a href="#tab33" class="font-weight-bold" data-toggle="tab">Origin</a></li>
                                            <li><a href="#tab44" class="font-weight-bold" data-toggle="tab">Delivery</a></li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group clearfix mt-3">
                                                        <div class="row ">
                                                            <div class="col-lg-3">
                                                                <label class="control-label form-label font-weight-bold"
                                                                       for="title">Purchasing officer : </label>
                                                            </div>
                                                            <div class="col-lg-9">
                                                                <input class="form-control required" id="title"
                                                                       name="title" type="text">
                                                    ...
                                                    <div class="form-group clearfix ">
                                                        <div class="row ">
                                                            <div class="col-lg-3">
                                                                <label class="control-label form-label font-weight-bold"
                                                                       for="title">Purchasing date : </label>
                                                            </div>
                                                            <div class="col-lg-9">
                        ...
                        <table class="table card-table table-vcenter  table-bordered">
                            ...
                            <tr>
                                <td colspan="2" rowspan="4" class="text-center">
                                    ...
                                    <div class="font-weight-bold ">Ali Azimi</div><br>
                                ...
                                <td colspan="2" rowspan="4" class="text-center">
                                    ...
                                    <div class="font-weight-bold ">Saba Nouri</div><br>
                                    <div><span class="font-weight-bold">Org code :</span><br> EM 0010506
                                    </div>
...
<div class="modal fade" id="guarantee-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="example-Modal3-1">Guarantee Info</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                            ...
                            <div class="panel panel-primary ">
                                <div class="  border-0">
                                    <div class="tabs-menu ">
                                        <!-- Tabs -->
                                        <ul class="nav panel-tabs">
                                            <li><a href="#tab1010" class="font-weight-bold active" data-toggle="tab">Guarantee</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="panel-body tabs-menu-body  border-left-0 border-right-0 border-bottom-0">
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab1010">
                                            <div class="row ">
                                                <div class="col-12">
                                                    <div class="form-group clearfix mt-3">
                                                        <div class="row ">
                                                            <div class="col-lg-3">
                                                                <label class="control-label form-label font-weight-bold"
                                                                       for="title">Guarantee start date : </label>
                                                            </div>
                                                            <div class="col-lg-9">
                                                                <div class="input-group">
                                                                    <div class="input-group-prepend">
