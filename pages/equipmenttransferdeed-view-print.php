                                ...
                                <div class="  border-0">
                                    <div class="tabs-menu ">
                                        ...
                                        <ul class="nav panel-tabs">
                                            ...
                                            <li><a href="#tab2-2" class="font-weight-bold" data-toggle="tab">Transfer Info </a></li>
                                            <li><a href="#tab3-3" class="font-weight-bold" data-toggle="tab">Delivery Place</a></li>
                                            <li><a href="#tab4-4" class="font-weight-bold" data-toggle="tab">Relation</a></li>
                                            <li><a href="#tab5-5" class="font-weight-bold" data-toggle="tab">Inform</a></li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="form-group clearfix ">
                                                        <div class="row ">
                                                            <div class="col-lg-3">
                                                                <label class="control-label form-label font-weight-bold"
                                                                       for="title">Equipment supply deed: </label>
                                                            </div>
                                                            <div class="col-lg-9">
                                                                <input class="form-control required" id="title"
                                                                       name="title" type="text">
                                                    ...
                                                    <div class="form-group  clearfix">
                                                        <div class="row ">
                                                            <div class="col-lg-3">
                                                                <label class="control-label form-label font-weight-bold">From inventory : </label>
                                                            </div>
                                                            <div class="col-lg-9">
                                                                <select class="form-control select2-show-search"
                                                                        data-placeholder="Choose one (with optgroup)">
                                                    ...
                                                    <div class="form-group  clearfix">
                                                        <div class="row ">
                                                            <div class="col-lg-3">
                                                                <label class="control-label form-label font-weight-bold">To inventory : </label>
                                                            </div>
                                                            <div class="col-lg-9">
                                                                <select class="form-control select2-show-search"
                                                                        data-placeholder="Choose one (with optgroup)">
                                                ...
                                                <div class="col-12">
                                                    <div class="card mt-5 mb-0">
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-4 ">
                                                                    <div class="card border-secondary text-center font-weight-bold text-muted">Requester</div>
                                                                </div>
                                                                <div class="col-4 ">
                                                                    <div class="card border-secondary text-center font-weight-bold text-muted">From person</div>
                                                                </div>
                                                                <div class="col-4 ">
                                                                    <div class="card border-secondary text-center font-weight-bold text-muted">To person</div>
                                                                </div>
                                                                <div class="col-4">
                                        ...
                                        <div class="tab-pane" id="tab2-2">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group clearfix mt-3">
                                                        <div class="row ">
                                                            <div class="col-lg-3">
                                                                <label class="control-label form-label font-weight-bold"
                                                                       for="FromDate">transfer date : </label>
                                                            </div>
                                                            <div class="col-lg-9">
                                                    ...
                                                    <div class="form-group clearfix">
                                                        <div class="row ">
                                                            <div class="col-lg-3">
                                                                <label class="control-label form-label font-weight-bold"
                                                                       for="FromTime">Transfer time :  </label>
                                                            </div>
                                                            <div class="col-lg-9">
                                                                <div class="input-group">
                                                                    <div class="input-group-prepend">
                                                    ...
                                                    <div class="form-group clearfix">
                                                        <div class="row ">
                                                            <div class="col-lg-3">
                                                                <label class="control-label form-label font-weight-bold"
                                                                       for="toTime">Delivery time :</label>
                                                            </div>
                                                            <div class="col-lg-9">
                                                                <div class="input-group">
                                                                    <div class="input-group-prepend">
                                                    ...
                                                    <div class="form-group  clearfix">
                                                        <div class="row ">
                                                            <div class="col-lg-3">
                                                                <label class="control-label form-label font-weight-bold">Transfer officer : </label>
                                                            </div>
                                                            <div class="col-lg-9">
                                                                <select class="form-control select2-show-search"
                                                                        data-placeholder="Choose one (with optgroup)">
                                                    ...
                                                    <div class="form-group  clearfix">
                                                        <div class="row ">
                                                            <div class="col-lg-3">
                                                                <label class="control-label form-label font-weight-bold">Transportation way : </label>
                                                            </div>
                                                            <div class="col-lg-9">
                                                                <select class="form-control select2-show-search"
                                                                        data-placeholder="Choose one (with optgroup)">
                                                    ...
                                                    <div class="card mt-5 mb-0">
                                                        <div class="card-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-3 ">
                                                                    <div class="card border-secondary text-center font-weight-bold text-muted">Transfer officer</div>
                                                                </div>
                                                                <div class="col-3">
                                                                    <div class="card border-secondary ">
                                                                        <div class="card-body text-center pt-3 ">
                                            ...
                                            <span class="avatar avatar-xl brround cover-image m-2"
                                                ...
                                                <span class="avatar-status bg-green"></span>
                                                                            ...
                                                                            <h5 class="mt-3 mb-0"><a class="hover-primary" href="#">Rahamat Moradi</a></h5>
                                                                            <span>Person Position</span>
                                                                            <div>
                                                                                <span class="badge badge-default">Transfer</span>
                                                                            </div>
                        ...
                        <table class="table card-table table-vcenter text-nowrap table-bordered">
                            ...
                            <tr>
                                <td colspan="2" rowspan="4" class="text-center">
                                    ...
                                    <div class="font-weight-bold ">Ali Azimi</div>
                                                ...
                                                <div class="table-responsive rounded-0">
                                                    <table class="table card-table table-vcenter text-nowrap table-primary">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Intact</td>
                                                            <td>
                                                                <button href="/inventory-view" class="btn-pill btn-outline-secondary btn-sm">Select</button>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">2</th>
