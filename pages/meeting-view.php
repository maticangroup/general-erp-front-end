    ...
    <div class="page-header  mb-0">
        ...
        <div class="float-right ml-auto">
            ...
            <a href="javascript:void(0)"
               class="btn btn-success btn-sm "><i class="fas fa-play"></i> Start</a>
            <a href="javascript:void(0)"
               class="btn btn-danger btn-sm "><i class="fas fa-stop"></i> Cancel</a>
            <a href="javascript:void(0)"
               class="btn btn-warning btn-sm "><i class="fas fa-pen"></i> Pause</a>

            <a href="javascript:void(0)" data-toggle="modal" data-target="#edit-modal"
               class="btn btn-primary btn-sm ml-3"><i class="fas fa-pen"></i> Edit</a>
        </div>
    </div>
</div>
<div class="row">
                            ...
                            <div class="  p-3 ">
                                <div class="tabs-menu ">
                                    ...
                                    <ul class="nav panel-tabs">
                                        ...
                                        <li><a href="#tab2" class="active font-weight-bold" data-toggle="tab">Meeting
                                                Info</a></li>
                                        <li class=""><a href="#tab1" class=" font-weight-bold"
                            ...
                            <div class="panel-body  tabs-menu-body border-0 ">
                                <div class="tab-content">
                                    <div class="tab-pane " id="tab1">
                                        <div class="row my-3">
                                            <div class="col-3 ">
                                                <div class="card border-success text-center font-weight-bold text-muted">
                                                    Meeting leader
                                                </div>
                                            </div>
                                            <div class="col-3 ">
                                            ...
                                            <div class="col-3 ">
                                                <div class="card border-secondary text-center font-weight-bold text-muted">
                                                    Guest
                                                </div>
                                            </div>
                                            <div class="col-3 ">
                                                <div class="card border-info text-center font-weight-bold text-muted">
                                                    Vendor
                                                </div>
                                            </div>
                                            <div class="col-3">
                                            ...
                                            <span class="avatar avatar-xl brround cover-image m-2"
                                                ...
                                                <span class="avatar-status bg-green"></span>
                                                        ...
                                                        <h5 class="mt-3 mb-0"><a class="hover-primary" href="#">Hossein
                                                                Azimi</a></h5>
                                                        <span>Person Position</span>
                                                        <div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="table-responsive ">
                                                            <table id="example-2"
                                                                ...
                                                                <thead>
                                                                <tr>
                                                                    <th class="wd-15p border-bottom-0 text-left">Title
                                                                    </th>
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <button type="button"
                                                                class="btn btn-success float-right ml-auto"
                                                                data-toggle="modal" data-target="#add-modal"><i
                                ...
                                <div class="  border-0">
                                    <div class="tabs-menu ">
                                        ...
                                        <ul class="nav panel-tabs">
                                            ...
                                            <li><a href="#tab3" class="font-weight-bold" data-toggle="tab">Timing</a>
                                            </li>
                                            <li><a href="#tab4" class="font-weight-bold" data-toggle="tab">place</a>
                                            </li>
                                            <li><a href="#tab5" class="font-weight-bold" data-toggle="tab">relation</a>
                                            </li>
                                                        ...
                                                        <div class="row ">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <select class="form-control">
                                                                    <option>Client ordering advice</option>
                                                                    <option>Close Contract</option>
                                                                    <option>B to B</option>
                                                                    <option>Planning meeting before hold project
                                                                    </option>
                                                                    <option>Daily stand up meeting</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group clearfix mt-3">
                                                        <div class="row ">
                                                            <div class="col-lg-3">
                                                                <label class="control-label form-label font-weight-bold"
                                                                       for="ProjectManager">Meating Leader :</label>
                                                            </div>
                                                            <div class="col-lg-9">
...
<div class="modal fade" id="editasdasdasdasd-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
