...
$(function (e) {
    ...
    let chart1 = document.getElementById('hightchart1');
    if (chart1 != null) {
...
$(function (e) {
    ...
    let chart2 = document.getElementById('highchart2');
    if (chart2 != null) {
...
$(function (e) {
    ...
    let chart3 = document.getElementById('highchart3');
    if (chart3 != null) {
        /* ---hightchart3----*/
        ...
        Highcharts.chart('highchart3', {
            ...
            series: [{
                ...
                name: 'Browser share',
                data: [
                    ['Meeting in project', 40.0],
                    ['Daily stand up meeting', 20.8],
                    {
                        name: 'Meeting type selected',
                        y: 18.8,
                        sliced: true,
                        selected: true
                    },
                    ['Project kick off', 12.5],
                    ['Portfolio demo', 6.2],
                    ['Internal', 2]
                ],
    ...
    let chart4 = document.getElementById('highchart4');
    if (chart4 != null) {
        /* ---hightchart4----*/
    ...
    let chart5 = document.getElementById('highchart5');
    if (chart5 != null) {
        /* ---hightchart5----*/
    ...
    let chart6 = document.getElementById('highchart6');
    if (chart6 != null) {
    ...
    let chart7 = document.getElementById('highchart7');
    if (chart7 != null) {
        /* ---hightchart7----*/
